...
# Cria uma topologia Butterfly com 4 diretórios, um em cada canto da topologia.
class ButterflyDirCorners_2(SimpleTopology):
    description='ButterflyDirCorners_2'
